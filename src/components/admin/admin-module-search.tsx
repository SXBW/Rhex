...
const ADMIN_MODULE_SEARCH_ITEMS: AdminModuleSearchItem[] = [
  ...
  { href: getAdminSettingsHref("profile", "appearance"), label: "主题外观", category: "站点设置子页", description: "分别配置桌面端、移动端默认主题和默认字号、默认界面模式、贴内图片模式，以及字号预设和五个主题预设配色。", keywords: ["主题外观", "主题预设", "字号预设", "默认主题", "默认字号", "默认界面模式", "白天模式", "黑夜模式", "跟随系统", "默认贴内图片模式", "贴内图片模式", "大图模式", "小图模式", "自动模式", "移动端默认主题", "移动端默认字号", "桌面端默认主题", "桌面端默认字号", "配色", "颜色", "小号", "中号", "大号"] },
